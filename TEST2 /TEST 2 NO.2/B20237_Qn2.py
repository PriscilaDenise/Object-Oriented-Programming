# DENISE PRISCILA MUWANGUZI   M23B23/010   B20237
...
student = Student("Peace",20,"Math")
instructor = Instructor("Karen",35,"Physics")
...
students = [
    {'id': 1, 'name': 'Deniz', 'age': 25, 'course': 'Law'},
    {'id': 2, 'name': 'Emma', 'age': 19, 'course': 'BSCS'},
    {'id': 3, 'name': 'Patricia', 'age': 26, 'course': 'VAD'},
]
